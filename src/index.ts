...
//NOTE: this is the problem in this type of chart see also line 116
...
Object.entries(dates).forEach(([years, data]) => {
  ...
  let [frozeDay, frozeMonth] = data['Jäätyminen'].Arvo.split('.')
  // jäätyminen[2] = '1900'
  let [meltDay, meltMonth] = data['Jäänlähtö'].Arvo.split('.')
  // jäänlähto[2] = '1901'
